...
export default function App() {
  ...
  return <main id="inicio" ref={page}>
    ...
    <section className="love-ode" aria-labelledby="ode-title"><span className="ode-rule"/><div data-reveal><Heart size={22} strokeWidth={1} aria-hidden="true"/><h2 id="ode-title">Ojalá la distancia<br/>fuera tan corta<br/><em>como este te quiero.</em></h2></div><span className="ode-rule"/></section>
