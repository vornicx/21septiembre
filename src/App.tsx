...
export default function App() {
  ...
  return <main id="inicio" ref={page}>
    ...
    <section className="dedication-section" id="dedicatoria" aria-labelledby="letter-title">
      ...
      <article className="love-letter" data-reveal><p className="small-label">PARA TI, HARIDIAN</p><h2 id="letter-title">Hay mil maneras<br/>de decir <em>te quiero.</em></h2><div className="letter-body"><p>Haridian,</p><p>Me habría encantado darte estas flores en persona.<br/>Ver tu cara al recibirlas. Y decirte, cerquita, lo mucho que te quiero.</p><p>Hoy me quedo con las ganas de abrazarte, de darte un beso y de pasar un rato contigo sin tener que mirar la hora ni pensar en que alguno de los dos se tiene que ir. Me quedo con las ganas de verte y decirte lo guapa que estás.</p><p>Me hace ilusión pensar en todo lo que nos queda por compartir. En los planes que todavía son solo ganas y planes, en las conversaciones que se alargan y en la promesa de volver a vernos cada día.</p><p>Estas flores amarillas van con todo mi cariño. Ojalá que al verlas sonrías y sientas un poquito de lo que me pasa a mí cuando pienso en ti o cuando te veo, incluso a través de la pantalla.</p><p>Y si hoy pudiera pedir algo, sería estar a tu lado, mirarte y decírtelo así, sin más:</p></div><p className="handwritten">Qué bonito es quererte, Haridian.</p><div className="signature">Con todo mi cariño,<span>Vadim</span></div></article>
    </section>
