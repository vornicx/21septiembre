...
export default function App() {
  ...
  return <main id="inicio">
    ...
    <section className={`letter-section ${opened?'is-open':''}`} id="nota" ref={letter} aria-labelledby="letter-title">
      <span className="letter-flower" aria-hidden="true">✳</span><p className="eyebrow">HARIDIAN, ESTO ES PARA TI</p><h2 id="letter-title">Me habría gustado<br/>llevarte <em>flores de verdad.</em></h2><p>Hoy no puedo, así que he hecho este pequeño rincón para ti. Para que, aunque sea a través de una pantalla, tengas tus flores amarillas.</p><p>Ojalá te saque una sonrisa.<br/>Eso es lo que quería regalarte hoy.</p><p className="love-note">Te quiero, Haridian.</p><div className="signature">Con todo mi cariño,<span>Vadim</span></div><Heart size={19} className="letter-heart" aria-hidden="true"/>
    </section>
